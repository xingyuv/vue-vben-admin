...
Vue Vben Admin 是一个免费开源的中后台模版。使用了最新的`vue3`,`vite4`,`TypeScript`,`Ant-Design-Vue-4.0`等主流技术开发，开箱即用的中后台前端解决方案，也可用于学习参考。
...
- [Ant-Design-Vue-4.0](https://antdv.com/docs/vue/introduce-cn/) - ui 基本使用
